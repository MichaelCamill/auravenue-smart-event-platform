...
- **Live Demo URL:** `https://michaelcamill.github.io/auravenue-smart-event-platform/` *(or run locally via `npm run dev`)*
...
🔗 Live Demo: https://michaelcamill.github.io/auravenue-smart-event-platform/
